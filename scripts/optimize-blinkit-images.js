...
// every new product inside generate-reports.js). Only touches rows that
// don't have an optimized_image_url yet, so rerunning this is always
// safe -- it just picks up the next unprocessed batch.
//
// Usage:
