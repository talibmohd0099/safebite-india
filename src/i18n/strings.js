...
export const STRINGS = {
  en: {
    ...
    personalPriorityNoted: 'Noted',
    personalPriorityClear: 'Nothing to flag',
    personalAllClearTitle: "Nothing here works against {name}'s priorities",
    personalAllClearBody: "Everything {name} has chosen to watch came back clear for this product, so their score matches the general one.",
