...
export const STRINGS = {
  en: {
    ...
    compareSubtitle: 'See which one actually fits you better.',
    compareEmptyTitle: 'Nothing selected to compare',
    compareEmptyBody: 'Pick 2-3 products from your history to compare them side by side.',
    compareBackToHistory: 'Go to history',
    compareMetricScore: 'Score',
    compareMetricFor: 'For {name}',
    compareMetricSugar: 'Sugar',
    compareMetricSodium: 'Sodium',
    compareMetricProtein: 'Protein',
    compareMetricAdditives: 'Additives',
    compareWhatDiffers: 'What differs?',
    compareNoRealDifference: 'These are close enough that no single factor clearly sets one apart from the rest.',
    compareMissingDataNote: '"—" means that product’s label/scan didn’t have a real number for this.',
  ...
  hi: {
    ...
    compareTitle: 'प्रोडक्ट्स की तुलना',
    compareSubtitle: 'देखें कौन सा आपके लिए ज़्यादा सही है।',
    compareEmptyTitle: 'तुलना के लिए कुछ भी चुना नहीं गया',
    compareEmptyBody: 'अपनी हिस्ट्री से 2-3 प्रोडक्ट चुनें, उन्हें साथ में तुलना करने के लिए।',
    compareBackToHistory: 'हिस्ट्री पर जाएं',
    compareMetricScore: 'स्कोर',
    compareMetricFor: '{name} के लिए',
    compareMetricSugar: 'शुगर',
    compareMetricSodium: 'सोडियम',
    compareMetricProtein: 'प्रोटीन',
    compareMetricAdditives: 'एडिटिव्स',
    compareWhatDiffers: 'क्या फर्क है?',
    compareNoRealDifference: 'ये इतने करीब हैं कि कोई एक चीज़ किसी को बाकियों से अलग नहीं करती।',
    compareMissingDataNote: '"—" का मतलब है उस प्रोडक्ट के लेबल/स्कैन में इसके लिए असली नंबर नहीं था।',
