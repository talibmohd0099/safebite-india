...
export const STRINGS = {
  en: {
    ...
    scoreModalIntro: "SafeBite evaluates ingredients and the overall product profile to estimate how healthy a product is. Here's what influenced this score.",
    scoreModalWhatInfluenced: 'What influenced your score?',
    scoreModalWhatInfluencedSubtitle: 'Every ingredient in this product, grouped by how much concern it raises.',
    tierDescHarmful: 'Banned or restricted, or a serious health risk on their own.',
    tierDescConcerning: 'Legal, but worth knowing about — things like added sugar or sodium that matter most with regular use.',
    tierDescProcessed: "Not flagged as risky on their own, but heavily refined, which can lower nutritional quality.",
    tierDescFine: 'No specific concerns — considered safe as used in this product.',
    scoreModalHowItWorks: 'How is the final score determined?',
    scoreModalHowItWorksIntro: 'Your score starts at 100 and is adjusted based on ingredient concerns and the overall product profile.',
    scoreModalStep1Title: 'Ingredients',
    scoreModalStep1Caption: 'Checked for potential health concerns',
    scoreModalStep2Title: 'Product profile',
    scoreModalStep2Caption: 'Quantity, processing, and category',
    scoreModalStep3Title: 'Final score',
    scoreModalStep3Caption: 'A balanced, science-informed estimate',
  ...
  hi: {
    ...
    scoreModalIntro: 'SafeBite सामग्री और पूरे प्रोडक्ट प्रोफाइल के आधार पर यह अंदाज़ा लगाता है कि कोई प्रोडक्ट कितना हेल्दी है। इस स्कोर पर इनका असर पड़ा है।',
    scoreModalWhatInfluenced: 'आपके स्कोर पर किसका असर पड़ा?',
    scoreModalWhatInfluencedSubtitle: 'इस प्रोडक्ट की हर सामग्री, कितनी चिंता पैदा करती है उसके आधार पर बांटी गई है।',
    tierDescHarmful: 'बैन या प्रतिबंधित, या खुद ही एक बड़ा हेल्थ रिस्क।',
    tierDescConcerning: 'कानूनी तौर पर ठीक, लेकिन जानना ज़रूरी है — जैसे अतिरिक्त चीनी या सोडियम, जो रोज़ खाने पर ज़्यादा मैटर करते हैं।',
    tierDescProcessed: 'खुद कोई बड़ा खतरा नहीं, लेकिन काफी रिफाइंड/प्रोसेस्ड है, जिससे न्यूट्रिशन क्वालिटी कम हो सकती है।',
    tierDescFine: 'कोई खास चिंता नहीं — इस प्रोडक्ट में जैसे इस्तेमाल हुई है, वैसे सुरक्षित मानी जाती है।',
    scoreModalHowItWorks: 'फाइनल स्कोर कैसे तय होता है?',
    scoreModalHowItWorksIntro: 'आपका स्कोर 100 से शुरू होता है और सामग्री की चिंताओं और पूरे प्रोडक्ट प्रोफाइल के आधार पर एडजस्ट होता है।',
    scoreModalStep1Title: 'सामग्री',
    scoreModalStep1Caption: 'संभावित हेल्थ चिंताओं के लिए जांची गई',
    scoreModalStep2Title: 'प्रोडक्ट प्रोफाइल',
    scoreModalStep2Caption: 'मात्रा, प्रोसेसिंग और कैटेगरी',
    scoreModalStep3Title: 'फाइनल स्कोर',
    scoreModalStep3Caption: 'एक बैलेंस्ड, साइंस पर आधारित अंदाज़ा',
