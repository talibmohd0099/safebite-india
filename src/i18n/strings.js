...
export const STRINGS = {
  en: {
    ...
    habitServingPack: 'a {grams}{unit} pack',
    habitServingPer100g: 'Every 100g',

    sugarAddsUpTitle: 'How much sugar this adds up to',
    ...
    sugarMonth: 'Month',
    sugarYear: 'Year',
    sugarYearPackets: 'In a year that’s about {kg} kg of sugar — {packets} × the 1 kg sugar packet.',
    sugarTspShort: 'teaspoons',
    sugarSwapFrequency: 'Having it once a week instead of every day means about {kg} kg less sugar a year.',
  ...
  hi: {
    ...
    habitServingPack: '{grams}{unit} के एक पैक',
    habitServingPer100g: 'हर 100 ग्राम',

    sugarAddsUpTitle: 'इससे कितनी चीनी जुड़ती है',
    sugarFreqDaily: 'रोज़',
    ...
    sugarMonth: 'महीना',
    sugarYear: 'साल',
    sugarYearPackets: 'साल भर में लगभग {kg} किलो चीनी — 1 किलो वाले {packets} पैकेट।',
    sugarTspShort: 'चम्मच',
    sugarSwapFrequency: 'रोज़ की जगह हफ़्ते में एक बार लेने से साल में लगभग {kg} किलो कम चीनी।',
